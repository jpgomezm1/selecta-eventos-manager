      ...
      <div className="mx-auto max-w-4xl px-6 pb-24">
        <header className="pt-14 md:pt-20">
          ...
          <h1 className="max-w-3xl font-serif text-[2rem] leading-[1.1] tracking-tight md:text-[3rem]">
            Dos archivos para que el sistema sepa cuánto cuesta cada plato
          </h1>
          ...
          <p className="mt-5 max-w-[63ch] text-lg leading-relaxed text-muted-foreground">
            ...
            y <strong className="font-semibold text-foreground">qué lleva cada plato</strong>. Sin
            esas dos cosas puede cotizar, pero no puede decirles cuánto ganan en un evento.
          </p>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-8 border-y border-border sm:grid-cols-3">
            ...
            />
            <Cifra
              valor={DATOS.recetasCargadas}
              label="Recetas ya cargadas"
              detalle={`${DATOS.lineasReceta.toLocaleString("es-CO")} líneas que sirven de ejemplo`}
            />
          </div>
        </header>
        ...
        <section className="pt-14">
          ...
          <p className="mt-3 max-w-[63ch] text-muted-foreground">
            Son dos porque los llena gente distinta y se pueden trabajar al mismo tiempo. Ninguno de
            los dos empieza en blanco: ya vienen con su catálogo adentro.
          </p>
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-2">
            {PLANTILLAS.map((p) => (
              <article
                key={p.archivo}
                className="flex flex-col gap-4 rounded-lg border border-border bg-card p-7 shadow-soft"
              >
        ...
        <section className="pt-14">
          <h2 className="font-serif text-2xl tracking-tight">
            Las dos reglas que cambian el resultado
          </h2>
          <p className="mt-3 max-w-[63ch] text-muted-foreground">
            Todo lo demás del archivo se explica solo. Estas dos son las que, si se entienden al
